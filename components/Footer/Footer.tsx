    ...
    return (
        <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-24">
            <div className="flex flex-col md:flex-row">
                ...
                <h3 className="font-bold text-2xl">Samsung Pro's</h3>
                ...
                <h5 className="uppercase tracking-wider font-semibold">Products</h5>
                <ul className="mt-4">
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">Smartphones</a></li>
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">Watches</a></li>
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">TVs</a></li>
                </ul>
                </div>
                ...
                <ul className="mt-4">
                    ...
                    <a href="#" title="" className="block flex items-center opacity-75 hover:opacity-100">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                            ...
                            <path d="M13 7L11 7 11 13 17 13 17 11 13 11z"></path></svg>
                        </span>
                        <span className="ml-3">
                ...
                <p className="text-sm text-gray-400 mt-12">© 2030 Samsung Pro's. <br className="hidden lg:block"/>All Rights Reserved.
                </p>
                </div>
            </div>
            </footer>
