...
const Header1 = () => {
    return (
        <div className="absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
            <div className="hidden lg:flex justify-between items-center py-2 border-b text-sm py-3" style={{"borderColor": "rgba(255,255,255,.25)"}}>
                <div className="" />
            ...
            <div className="flex flex-wrap items-center justify-between py-6">
                ...
                <nav className="w-full bg-white md:bg-transparent rounded shadow-lg px-6 py-4 mt-4 text-center md:p-0 md:mt-0 md:shadow-none">
                    ...
                    <li className="md:ml-6 mt-3 md:mt-0">
                        <a className="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded" href="/dentalpro/book-appointment">Book
                        Appointment</a>
                    </li>
                    </ul>
                </nav>
